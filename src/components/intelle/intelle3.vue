<template>
  <div class="intelle3">
      ...
      <div class="tableModel">
        ...
        <div class="tableBox">
          ...
          >
            ...
            <el-table-column prop="Category" label="作品类别" width="150">
            </el-table-column>
            <el-table-column prop="FinishDate" label="创作完成日期" width="200">
            </el-table-column>
            <el-table-column prop="RegisterDate" label="登记日期" width="200">
            </el-table-column>
            <el-table-column
              prop="PublishDate"
              label="首次发布日期"
    ...
    <el-dialog title="添加" :close-on-click-modal="false" :visible.sync="addDialog" width="25%">
      <div class="Addtitle">作品著作权信息</div>
      <el-form :model="form" :rules="rules" ref="zlform">
        <el-form-item label="著作名称" prop="name" label-width="180px">
        ...
        <el-form-item label="作品类别" prop="category" label-width="180px">
        ...
        <el-form-item label="登记日期" prop="registerDate" label-width="180px">
          <el-date-picker
...
export default {
  ...
  methods: {
    getZLData() {
      ...
      // }
      this.tableData = [];
      searchCopyRight(this.keyNo, this.page.pageNum, this.page.pageSize).then(
        (res) => {
          console.log(res);
          // if (res.code != 200) {
          //   this.$message.error("获取作品著作数据失败！");
          //   return;
          // }
    ...
    deleteDialogClick() {
      ...
      deleteCopyright(checkArrId.join()).then((res) => {
        console.log(res);
        if (res.code != 200) {
    ...
    ZLsubmitBtn() {
      ...
      this.$refs.zlform.validate((valid) => {
        ...
        addCopyright(this.form).then((res) => {
          console.log(res);
          if (res.code != 200) {
    ...
    DCsubmitBtn() {
      if (this.form2.radio1 == "1") {
        ...
        exportCopyright(itemArr.join()).then((res) => {
          console.log(res);
          if (res.code != 200) {
