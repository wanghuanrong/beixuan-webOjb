    ...
    <el-dialog :visible.sync="dialogVisible" width="900px">
      <div class="dialogbox">
        ...
        <div class="rightContent">
          <div class="contentbox" ref="titleContentBox">
            <div class="title">
...
<script>
import { nextStep, lastStep, generate, batchList } from "@/utils/total.js";
import { getNote } from "@/utils/match.js";
          ...
          if (res.data.schemeSize == 0) {
            ...
            if (res.data.templateList.length != 0) {
              ...
              generate().then((res) => {
                ...
                this.$router.push({
                  path: "/backhome/policymanage/estimateXm",
                  query: {
                    matchBatchNo: res.data.matchBatchNo,
                    estimateBatchNo: res.data.estimateBatchNo,
                  },
                });
              });
            }
