        ...
        <div class="content">
          <div class="payAdiao">
            <el-radio v-model="radio" label="1">
              <div class="img">
                <img v-lazy="require('@/assets/shop/zfb.png')" alt="" />
              </div>
              支付宝支付
            </el-radio>
            <el-radio v-model="radio" label="2">
              <div class="img">
                <img v-lazy="require('@/assets/shop/wx.png')" alt="" />
              </div>
              微信支付
            </el-radio>
            <el-radio v-model="radio" label="3">
              <div class="img">
                <img v-lazy="require('@/assets/shop/yl.png')" alt="" />
              </div>
              银行转账
            </el-radio>
          </div>
...
export default {
  ...
  methods: {
    ...
    handleClose1(){
      ...
      sessionStorage.setItem('childActivePath', "/backhome/companycenter/myOrder");
    },
    dialogClick(index) {
