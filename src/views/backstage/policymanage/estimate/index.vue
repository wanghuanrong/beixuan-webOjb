<template>
  <div class="match">
    ...
    <el-card>
      <el-steps class="topes" :active="active">
          ...
          >
            ...
            <el-row>
              <el-form-item class="titleleft">
                ...
                <el-checkbox-group v-model="formhonor.addjibie" size="medium">
            ...
            <el-row>
              <el-form-item class="titleleft">
                ...
                <el-checkbox-group
                  ...
                  size="medium"
                >
                  <el-checkbox :label="1" name="type5">正常营业</el-checkbox>
            ...
            <el-row>
              <el-form-item class="titleleft">
                ...
                <el-checkbox-group v-model="formhonor.addsixChek" size="medium">
                  ...
                  <el-checkbox :label="9" name="type5"
                    >引入风险投资</el-checkbox
                  >
            ...
            <el-row>
              <el-form-item class="titleleft">
                ...
                <el-form-item prop="addsevenChek" label="首次纳统年度">
                  <el-select
                    :popper-append-to-body="false"
                    v-model="formhonor.addsevenChek"
                    placeholder="请选择首次纳统年度"
                  >
                    <el-option label="未入纳统年度" :value="0"></el-option>
                ...
                <el-form-item>
                  <el-checkbox-group v-model="formhonor.addeightChek">
                    <el-checkbox :label="1">国家技术高新技术企业</el-checkbox>
        ...
        <div class="honor">
          ...
          <table class="tabzz" border="1" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td>
                <el-input
                  ...
                  placeholder="请输入净资产"
                  @blur="blurzc"
                  @change="changeBlurlr('twoinputzc')"
                  maxlength="11"
                ></el-input>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <el-input
                  v-model.trim="forminput.threeinputxs"
                  onkeyup="this.value=this.value.match(/\d+\.?\d{0,2}/);this.dispatchEvent(new Event('input'))"
                  placeholder="请输入销售收入"
                  maxlength="11"
                ></el-input>
              ...
              <td>
                <el-input
                  v-model.trim="forminput.threeinputlr"
                  oninput="value=value.replace(/[^\-?\d.]/g,'').replace(/^\./g,'').replace('.','$#$').replace(/\./g,'').replace('$#$','.').replace('-','$#$').replace(/\-/g,'').replace('$#$','-').replace( /([0-9]+\.[0-9]{2})[0-9]*/,'$1').replace(/[^\-?\d.]/g,'')"
                  placeholder="请输入净利润"
              ...
              <td>
                <el-input
                  v-model.trim="forminput.threeinputzc"
                  oninput="value=value.replace(/[^\-?\d.]/g,'').replace(/^\./g,'').replace('.','$#$').replace(/\./g,'').replace('$#$','.').replace('-','$#$').replace(/\-/g,'').replace('$#$','-').replace( /([0-9]+\.[0-9]{2})[0-9]*/,'$1').replace(/[^\-?\d.]/g,'')"
                  placeholder="请输入净资产"
              ...
              <td>
                <el-input
                  v-model.trim="forminput.threeinputns"
                  onkeyup="this.value=this.value.match(/\d+\.?\d{0,2}/);this.dispatchEvent(new Event('input'))"
                  placeholder="请输入纳税额"
                  maxlength="11"
                ></el-input>
              ...
              <td>
                <el-input
                  v-model.trim="forminput.threeinputyf"
                  onkeyup="this.value=this.value.match(/\d+\.?\d{0,2}/);this.dispatchEvent(new Event('input'))"
                  placeholder="请输入研发费用"
                  maxlength="11"
                ></el-input>
              ...
              <td>
                <el-input
                  v-model.trim="forminput.threeinputsbei"
                  onkeyup="this.value=this.value.match(/\d+\.?\d{0,2}/);this.dispatchEvent(new Event('input'))"
                  placeholder="请输入设备投入"
                  maxlength="11"
                ></el-input>
              ...
              <td>
                <el-input
                  v-model.trim="forminput.threeinputrj"
                  onkeyup="this.value=this.value.match(/\d+\.?\d{0,2}/);this.dispatchEvent(new Event('input'))"
                  placeholder="请输入信息化软件费"
                  maxlength="11"
                ></el-input>
              ...
              <td>
                <el-input
                  v-model.trim="forminput.threeinputpp"
                  onkeyup="this.value=this.value.match(/\d+\.?\d{0,2}/);this.dispatchEvent(new Event('input'))"
                  placeholder="请输入品牌推广费"
                  maxlength="11"
                ></el-input>
                    ...
                    <template slot="label"
                      ><span
                        style="
                          ...
                          margin-left: -61px;
                        "
                        ><span style="color: red">*</span>实用性新型专利</span
                      ></template
                    >
                    <el-input
    ...
    <div class="formmaintwo" style="position: relative" v-if="active === 1">
      <el-card>
    ...
    <!-- 第三块面板 -->
    <div class="formmainthree"  style="position: relative"  v-if="active === 2">
      <el-card>
        <div class="returnUp" @click="active--">&lt;返回上一层</div>
        <!-- 上传Excel文件按钮（第三级） -->
...
import { addMatch } from "@/utils/total.js";

import mathching3 from "@/components/matching3/mathching3";
export default {
  data() {
    return {
      token: null,
      ...
      rules: {
        ...
        // -----------------------------------------------------------
        addsevenChek: [
          { required: true, message: "请选择首次纳统年度", trigger: "blur" },
          {
            validator: numberIs,
            message: "请选择首次纳统年度",
            trigger: "blur",
  ...
  mounted() {
    //  document.querySelector(".topes").scrollIntoView();
  },
  methods: {
    //  匹配默认信息
    getAllInfo() {
      ...
      // this.formData.adddate = creatdata;

      // let startDate=/\d{4}-\d{1,2}-\d{1,2}/g.exec(creatdata)
      // const date=startDate[0]
      // this.formData.adddate=date
    },
    getTreeData(data) {
    ...
    async submitForm() {
      ...
      try {
        ...
        return this.$message.error("请查看是否有未填写项或者填写是否正确！");
      }
      ...
      const finalist = [
        ...
        },
        {
          ...
          netAssets: this.forminput.threeinputlr, // 净资产
          netProfit: this.forminput.threeinputzc, // 净利润
      ...
      const propeList = [
        // 国内
        {
          ...
          circuitDiagram: this.formcontry.waiguan.jichen, //集成电路
      ...
      const addmatchform = {
        ...
        honorEight: this.formhonor.addeightChek.toString(), // 企业资质
        ...
        honorSeven: this.formhonor.addsevenChek, // 获奖级别
    ...
    changese() {
      ...
      this.formindustry = arr1.join(",");
      // console.log(this.formindustry);
    },
    blurxs() {
      console.log(this.forminput.twoinputxs);
      console.log(this.forminput.oneinputxs);
      console.log("111");
      if (this.forminput.twoinputxs == "" || this.forminput.oneinputxs == " ") {
        return;
      }

      if (this.forminput.twoinputxs == 0) {
        return;
      }
    ...
    blurlr() {
      if (this.forminput.oneinputlr === "" || this.forminput.twoinputlr === "")
        return;
    ...
    blurzc() {
      if (this.forminput.oneinputzc === "" || this.forminput.twoinputzc === "")
        return;
